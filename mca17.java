class StringFunc
{
 ...
 {            
            String s1 = new String("My name is sushant") ;
            String s2 = new String("My name is mohit");
            char[] ch = new char[] { 'g', 'G' };
            char[] copy;
            int i;
            System.out.println("The string is :- " + s1);
            System.out.println("The second string is :- " + s2);
            System.out.println("The existence of sushant in string1 is :- " + s1.contains("sushant"));
            ...
            System.out.println("The existence of arg in end in string1 is :- "+s1.endsWith("ant"));
